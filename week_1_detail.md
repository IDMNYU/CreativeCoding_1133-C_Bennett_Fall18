...
<td valign="top">do</td>
	<!-- day Tues -->
 	<td valign="top"> 
 		<a href = "ttps://creativecoding1133c.slack.com/"><li>Look in your NYU email for a Slack invitation to join the Slack channel for this course</li> </a>
 		<li>Get a <a href = https://github.com/>Github 	account</a></li>
		<li>Direct Message me on Slack, your Github handle (ie, GitHub name).</li>
